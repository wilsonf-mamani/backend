# Generated by Django 4.0.1 on 2022-01-15 21:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personaFechaNacimiento', models.DateField(db_column='fech_nac')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personaEstadoCivil', models.CharField(choices=[('ACTIVA', 'ACTIVA'), ('CANCELADA', 'CANCELADA'), ('POSPUESTA', 'POSPUESTA')], db_column='estado', max_length=50)),
                ('createdAt', models.DateTimeField(auto_now=True, db_column='create_at')),
